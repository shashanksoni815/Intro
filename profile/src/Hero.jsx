...
further develop technical expertise in front-end and full-stack development.</p>
    </div>
    </>
  )
}
...
//   const name = "Shashank Soni"; // 👈 Replace with your name
//   const [displayedText, setDisplayedText] = useState("");

//   useEffect(() => {
//     let i = 0;
//     const interval = setInterval(() => {
//       setDisplayedText((prev) => prev + name[i]);
//       i++;
